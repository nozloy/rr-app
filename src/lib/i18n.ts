...
const dictionaries: Record<AppLocale, DictionaryNode> = {
	en: {
		...
		errors: {
			...
			blizzardProfileUnavailable:
				'Character exists, but Blizzard API does not expose raid lockout data for it.',
			notFound: 'Not found.',
		...
		raidcheck: {
			...
			roleNone: 'No role',
			readinessGood: 'Good',
			readinessLocked: 'Locked',
			readinessReview: 'Review',
			lockedBosses: 'locked bosses',
			detailsLoading: 'Loading character details...',
			average: 'Average',
			raiderIoRating: 'Raider.IO rating',
			currentSeason: 'Current season',
			raidReadiness: 'Raid readiness',
			tabAll: 'All',
			tabHeroic: 'Heroic',
			tabMythic: 'Mythic',
			sortBest: 'Sort: Best first',
			sortWorst: 'Sort: Worst first',
			sortName: 'Sort: Name',
			insights: 'Insights',
			strongestEncounter: 'Strongest encounter',
			weakestEncounter: 'Weakest encounter',
			raiderIoSummary: 'Raider.IO summary',
			regionRank: 'region rank',
			bestMythicRun: 'Best Mythic+ run',
			noCurrentRuns: 'No current runs',
			updatedToday: 'Updated today',
			addBookmark: 'Save character',
			removeBookmark: 'Remove saved character',
			copyCharacterName: 'Copy character name',
			copyWarcraftLogsLink: 'Copy Warcraft Logs link',
			copyRaiderIoLink: 'Copy Raider.IO link',
	...
	ru: {
		...
		raidcheck: {
			...
			readinessLocked: 'Есть КД',
			readinessReview: 'Проверить',
			lockedBosses: 'боссов с КД',
			detailsLoading: 'Загружаем детали персонажа...',
			average: 'Среднее',
			raiderIoRating: 'Рейтинг Raider.IO',
			currentSeason: 'Текущий сезон',
			raidReadiness: 'Готовность к рейду',
			tabAll: 'Все',
			tabHeroic: 'Героик',
			tabMythic: 'Мифик',
			sortBest: 'Сортировка: лучшие',
			sortWorst: 'Сортировка: слабые',
			sortName: 'Сортировка: имя',
			insights: 'Инсайты',
			strongestEncounter: 'Сильный босс',
			weakestEncounter: 'Слабый босс',
			raiderIoSummary: 'Сводка Raider.IO',
			regionRank: 'ранг региона',
			bestMythicRun: 'Лучший Mythic+',
			noCurrentRuns: 'Нет актуальных ключей',
			updatedToday: 'Обновлено сегодня',
			addBookmark: 'Сохранить персонажа',
			removeBookmark: 'Убрать из сохраненных',
			copyCharacterName: 'Скопировать имя',
			copyWarcraftLogsLink: 'Скопировать ссылку Warcraft Logs',
			copyRaiderIoLink: 'Скопировать ссылку Raider.IO',
			openArmory: 'Открыть Armory',
