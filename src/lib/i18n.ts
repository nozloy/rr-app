...
const dictionaries: Record<AppLocale, DictionaryNode> = {
  en: {
    ...
    home: {
      ...
      featureRolesText:
        "Tune roles and participant ranges for each activity.",
      footerAbout: "About",
      footerRules: "Rules",
  ...
  ru: {
    ...
    events: {
      ...
      myCharacterHintMulti: "Нажмите на карточку, чтобы выбрать другого персонажа",
      ...
      typeSeason: "Сезон",
      typeWorld: "Мир",
      instancesHint: "Выберите один или несколько инстансов соответствующего типа.",
