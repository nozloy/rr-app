...
const dictionaries: Record<AppLocale, DictionaryNode> = {
	en: {
		...
		raidcheck: {
			...
			addonDownloadTitle: 'Latest addon version is available',
			addonDownloadCopy: 'Download RaidReminder on CurseForge',
			...
			lockout: 'Lockout',
			logs: 'Logs',
			readyForRaid: 'Ready for raid',
			checkRequired: 'Review required',
			allClasses: 'All classes',
			allLockouts: 'All lockouts',
			searchPlayer: 'Search player',
			searchPlaceholder: 'Search player or realm...',
			actions: 'Actions',
			noFilteredRows: 'No players match current filters.',
			openCharacterDetails: 'Open details for {name}',
			character: 'Character',
			logsLoading: 'Loading Warcraft Logs data...',
			logsError: 'Could not load Warcraft Logs data',
			noPublicLogs: 'No public logs found',
			noPublicLogsHint:
				'Warcraft Logs can return empty data when the character has no public logs in the current tier.',
			averageParse: 'Average parse',
			bestParse: 'Best parse',
			averageParseShort: 'Avg',
			bestParseShort: 'Best',
			bossParses: 'Boss parses',
			logsUnavailable: 'Logs are unavailable.',
			logsUnsupportedDifficulty:
				'Logs in this table are available for Heroic and Mythic only.',
			logsNoDataForDifficulty: 'No parses for the selected difficulty.',
			heroicLogs: 'Heroic logs',
			mythicLogs: 'Mythic logs',
			noRankings: 'No rankings for this difficulty.',
			gear: 'Gear',
	...
	ru: {
		...
		raidcheck: {
			...
			exportReady: 'Строка экспорта готова',
			type: 'Тип',
			raid: 'Рейд',
			notRaid: 'Не рейд',
			ready: 'Готово',
			...
			lockout: 'КД',
			logs: 'Логи',
			readyForRaid: 'Готово к рейду',
			checkRequired: 'Нужна проверка',
			allClasses: 'Все классы',
			allLockouts: 'Все КД',
			searchPlayer: 'Поиск игрока',
			searchPlaceholder: 'Поиск игрока или сервера...',
			actions: 'Действия',
			noFilteredRows: 'Под текущие фильтры никто не подходит.',
			openCharacterDetails: 'Открыть детали персонажа {name}',
			character: 'Персонаж',
			logsLoading: 'Загружаем данные Warcraft Logs...',
			logsError: 'Не удалось загрузить данные Warcraft Logs',
			noPublicLogs: 'Публичные логи не найдены',
			noPublicLogsHint:
				'Warcraft Logs может вернуть пустой результат, если персонаж не участвовал в публичных логах текущего tier.',
			averageParse: 'Средний parse',
			bestParse: 'Лучший parse',
			averageParseShort: 'Ср.',
			bestParseShort: 'Луч.',
			bossParses: 'Парсы по боссам',
			logsUnavailable: 'Логи недоступны.',
			logsUnsupportedDifficulty:
				'Логи в этой таблице доступны только для героика и мифика.',
			logsNoDataForDifficulty: 'Нет парсов для выбранной сложности.',
			heroicLogs: 'Героик логи',
			mythicLogs: 'Мифик логи',
			noRankings: 'Для этой сложности нет рейтингов.',
			gear: 'Экипировка',
